	...
	*/
	...
	public function productImport()
	{
		...
		for ($current_line = 0; $line = fgetcsv($handle, MAX_LINE_SIZE, $this->separator); $current_line++)
		{
            ...
            // MGM 09/11/15 AÑADIDO PARA QUE NO DE ERROR DE date-upd CUANDO SE IMPORTA UN CSV Y EL ARTÍCULO YA EXISTE
			...
			if ($field_error === true && $lang_field_error === true)
			{
                ...
                // MGM 09/11/15 CAMBIADA LÍNEA PARA QUE NO DE ERROR AL IMPORTAR UN CSV Y EL ARTÍCULO YA EXISTE
			...
			else
			{
				...
				//MGM AÑADIDO 14/01/15 PARA QUE FUNCIONE EL SCRIPT DE IMPORTACIÓN
