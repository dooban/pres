			...
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="required form-group">
						...
						<label for="firstname">Nombre / Empresa <sup>*</sup></label>
 ...
 -->					{if isset($newsletter) && $newsletter}
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						<div class="required form-group">
							...
							<label for="firstname_invoice">Nombre / Empresa <sup>*</sup></label>
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			...
			<div class="required form-group">
				...
				<label for="customer_firstname">Nombre / Empresa <sup>*</sup></label>
			...
			<div class="form-group">
				...
				<input onkeyup="$('#lastname').val(this.value);" type="text" class="validate form-control" data-validate="isName" id="customer_lastname" name="customer_lastname" value="{if isset($smarty.post.customer_lastname)}{$smarty.post.customer_lastname}{/if}" />
			</div>
			<div class="required form-group">
