...
<div id="mywishlist">
	...
	<div class="align_right">El <b>Frigodent</b> es un sistema que nos permite recordar con facilidad los productos que nos hacen falta pero que todavía no estamos listos para comprar. Funciona de la misma forma que las notas que ponemos en la nevera para que no se nos olvide comprar algún producto necesario.
	<br><br>
	El funcionamiento es muy sencillo: cuando visitemos un producto tenemos la opción de añadir el producto al Frigodent haciendo click sobre la opción. Cuando visitemos el Frigodent, veremos que el producto está allí.
	<br><br>
	Adicionalmente, cada vez que confirme un pedido se creará automáticamente una lista con los artículos del pedido. En pedidos futuros podrá revisar los artículos que ya ha comprado para asegurarse de no olvidar nada o para recordar qué fue aquello que pidió que no se acuerda del nombre. Desde la lista podrá añadir los productos directamente al carrito de la compra.
	<br><br>
	Para ver los productos que contiene una lista, haga click sobre su nombre.
	<br>
	<br>
	</div>
