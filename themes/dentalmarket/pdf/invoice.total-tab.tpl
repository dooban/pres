...
<table id="total-tab" width="100%">
	...
	<tr>
		...
		<td class="white" width="30%">
			{displayPrice currency=$order->id_currency price=$footer.products_before_discounts_tax_excl - $footer.product_discounts_tax_excl}
		</td>
	</tr>
...
<table id="total-tab" width="100%">
	...
	{foreach $order_details as $order_detail}
		{$pvp = $pvp  + ($order_detail.product_price*$order_detail.product_quantity)}
		{$neto= $neto + ($order_detail.unit_price_tax_excl*$order_detail.product_quantity)}
	{/foreach}
	<tr>
	<td class="grey" width="70%">
		{l s='Ahorro en este pedido' pdf='true'}
	</td>
	<td class="white" width="30%">
		{displayPrice currency=$order->id_currency price=$pvp-$neto+$footer.product_discounts_tax_excl}
	</td>
	</tr>
