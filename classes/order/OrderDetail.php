...
class OrderDetailCore extends ObjectModel
{
	...
	// MGM 27/01/16 añadido para que se copie en la tabla de detalle de pedidos la descripción de la oferta
	public $product_desoferta;
	...
	public static $definition = array(
		...
		'fields' => array(
			...
			// MGM 27/01/16 añadido para que se copie en la tabla de detalle de pedidos la descripción de la oferta
			'product_desoferta' => 			array('type' => self::TYPE_STRING, 'validate' => 'isString')
		),
	);
	...
	protected function create(Order $order, Cart $cart, $product, $id_order_state, $id_order_invoice, $use_taxes = true, $id_warehouse = 0)
	{
		...
		// MGM 27/01/16 añadido para que se copie en la tabla de detalle de pedidos la descripción de la oferta
		$this->product_desoferta = $product['desoferta'];
